...
########################
# Location.create(name: "GW1", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)
# Location.create(name: "GW2", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)
# Location.create(name: "GW3", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)
# Location.create(name: "GW4", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)
# Location.create(name: "GW5", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)
# Location.create(name: "GW6", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)
# Location.create(name: "GW7", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)
# Location.create(name: "GW8", lat: 0, lng: 0, location_type: "intersection", lodging_site: false)

# RouteSegment.create(nw_end: 86, se_end: 89, road: "The Paths of the Dead")
# RouteWarning.create(route_segment_id: 76, text: "No one walks this road safely. There is an army of dead here that allows no one to pass.")
# route = RouteSegment.find(47)
# route.destroy

# RouteSegment.create(nw_end: 86, se_end: 112, road: "Harad Road")
# RouteSegment.create(nw_end: 112, se_end: 113, road: "Harad Road")
# RouteSegment.create(nw_end: 113, se_end: 114, road: "Harad Road")
# RouteSegment.create(nw_end: 114, se_end: 115, road: "?Small West Road")
# RouteSegment.create(nw_end: 115, se_end: 116, road: "?Small West Road")
# RouteSegment.create(nw_end: 116, se_end: 117, road: "?Small West Road")
